...
export default function Pofile() {
  ...
  const handleFormAddKids = ()=>{  
    setAnak(anak + 1)
    console.log(selectedData)
  }
 const handleFormLessKids = () => {  
  setAnak(anak - 1);
  ...
  return (
    <>
      {data ? (
        <>
          <OtpVaksinasi idxSelected={anak} visible={visible} data={data} form={formData} setVisible={() => setVisible(false)} />
